...
function assertRename(expected, document, newName, position) {
    ...
    const renameResult = MessageHandler_1.handleRenameRequest(params, document);
...
suite('Rename', () => {
    ...
    const renameModel = helper_1.getTextDocument(renameModelPath);
    const renameField = helper_1.getTextDocument(renameFieldPath);
    const renameEnum = helper_1.getTextDocument(renameEnumPath);
    const renameModelWithJsonDefault = helper_1.getTextDocument(renameModelWithJsonDefaultPath);
    const renameFieldLargeSchema = helper_1.getTextDocument(renameFieldLargeSchemaPath);
    const renameMultipleModels = helper_1.getTextDocument(renameMultipleModelsPath);
    const renameModelBug = helper_1.getTextDocument(renameModelBugPath);
